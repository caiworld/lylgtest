...
public class ReceiveAddressActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        abstractAddress.setHint("收获地址");
        name.setHint("收货人姓名");
        number.setHint("收货人电话");
    }
...
//                Log.e("getBusinessCircle", result.getBusinessCircle());
//                List<PoiInfo> poiList = result.getPoiList();
//                for (PoiInfo info : poiList) {
//                    Log.e("getPoiList", "address"+info.address+";name:"+info.name);
//                }
            }
        });
    }
    ...
    private void haveFinished() {
        ...
        intent.putExtra("rabsAddress", abstractAddress.getText().toString().trim());
        intent.putExtra("rdetailAddress", detailAddress.getText().toString().trim());
        intent.putExtra("rname", name.getText().toString().trim());
        intent.putExtra("rnumber", number.getText().toString().trim());
